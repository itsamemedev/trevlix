...
def bullish_row():
    ...
    return {
        "close": 31000, "high": 31200, "low": 30800,
        "ema8": 30900, "ema21": 30700, "ema50": 30500, "ema200": 30000,
        "rsi": 55, "stoch_rsi": 50,
        "macd": 50, "macd_signal": 30, "macd_hist": 20, "macd_hist_slope": 5,
        "bb_pct": 0.6, "bb_upper": 31500, "bb_lower": 30200, "sma20": 30850,
        "vol_ratio": 1.2, "obv": 100000, "obv_ema": 95000,
        "roc10": 4.0, "roc20": 6.0,
        "ichi_above": 1, "ichi_tenkan": 30800, "ichi_kijun": 30600,
        "price_vs_vwap": 0.02, "vwap": 30700,
        "ema_alignment": 0.8, "price_vs_ema21": 0.01,
        "atr14": 200, "atr_pct": 0.65, "vol_ma20": 5000, "returns": 0.01,
    }
...
def bearish_row():
    ...
    return {
        "close": 29000, "high": 29200, "low": 28800,
        "ema8": 29200, "ema21": 29500, "ema50": 29800, "ema200": 30500,
        "rsi": 70, "stoch_rsi": 80,
        "macd": -50, "macd_signal": -30, "macd_hist": -20, "macd_hist_slope": -5,
        "bb_pct": 0.96, "bb_upper": 29300, "bb_lower": 28700, "sma20": 29000,
        "vol_ratio": 2.5, "obv": 80000, "obv_ema": 85000,
        "roc10": -4.0, "roc20": -6.0,
        "ichi_above": 0, "ichi_tenkan": 29300, "ichi_kijun": 29500,
        "price_vs_vwap": -0.02, "vwap": 29500,
        "ema_alignment": -0.8, "price_vs_ema21": -0.01,
        "atr14": 250, "atr_pct": 0.86, "vol_ma20": 4000, "returns": -0.01,
    }
...
def neutral_row():
    ...
    return {
        "close": 30000, "high": 30100, "low": 29900,
        "ema8": 30010, "ema21": 30000, "ema50": 29990, "ema200": 30000,
        "rsi": 50, "stoch_rsi": 50,
        "macd": 0, "macd_signal": 0, "macd_hist": 0, "macd_hist_slope": 0,
        "bb_pct": 0.5, "bb_upper": 30500, "bb_lower": 29500, "sma20": 30000,
        "vol_ratio": 1.0, "obv": 90000, "obv_ema": 90000,
        "roc10": 0.5, "roc20": 1.0,
        "ichi_above": 1, "ichi_tenkan": 30000, "ichi_kijun": 30000,
        "price_vs_vwap": 0.0, "vwap": 30000,
        "ema_alignment": 0.0, "price_vs_ema21": 0.0,
        "atr14": 150, "atr_pct": 0.5, "vol_ma20": 5000, "returns": 0.001,
    }
