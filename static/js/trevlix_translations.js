...
const QT = {
  ...
  web_hero_eyebrow:    {de:'v1.7.1 · trevlix.dev · Open Source',en:'v1.7.1 · trevlix.dev · Open Source',es:'v1.7.1 · trevlix.dev · Código Abierto',ru:'v1.7.1 · trevlix.dev · Открытый код',pt:'v1.7.1 · trevlix.dev · Código Aberto'},
  ...
  ws_bad_exchange:      {de:'Ungültige Exchange',en:'Invalid exchange',es:'Exchange inválido',ru:'Недопустимая биржа',pt:'Exchange inválida'},
  ws_exchange_changed:  {de:'Exchange gewechselt',en:'Exchange changed',es:'Exchange cambiada',ru:'Биржа переключена',pt:'Exchange alterada'},
  ws_exchange_connect_failed:{de:'Exchange-Verbindung fehlgeschlagen',en:'Exchange connection failed',es:'Fallo de conexión con exchange',ru:'Ошибка подключения к бирже',pt:'Falha de conexão com a exchange'},
  ws_exchange_error:    {de:'Exchange-Fehler',en:'Exchange error',es:'Error de exchange',ru:'Ошибка биржи',pt:'Erro da exchange'},
  ws_exchange_keys_memonly:{de:'Exchange-Keys nur im RAM gespeichert',en:'Exchange keys saved in memory only',es:'Claves de exchange guardadas solo en memoria',ru:'Ключи биржи сохранены только в памяти',pt:'Chaves da exchange guardadas apenas na memória'},
  ws_markets_disk_cache:{de:'Exchange nicht erreichbar – nutze persistenten Markt-Cache',en:'Exchange unreachable – using persistent market cache',es:'Exchange no disponible: usando caché persistente de mercados',ru:'Биржа недоступна — используется постоянный кэш рынков',pt:'Exchange indisponível — usando cache persistente de mercados'},
  ws_no_markets_loaded: {de:'Keine frischen Märkte geladen – nutze letzte Marktliste',en:'No fresh markets loaded – using last market list',es:'No se cargaron mercados nuevos: usando la última lista',ru:'Свежие рынки не загружены — используется последний список',pt:'Sem mercados novos carregados — usando última lista'},
  ws_no_markets_available:{de:'Keine Märkte verfügbar – Exchange nicht erreichbar',en:'No markets available – exchange unreachable',es:'No hay mercados disponibles: exchange no disponible',ru:'Рынки недоступны — биржа не отвечает',pt:'Sem mercados disponíveis — exchange indisponível'},
  ws_bot_loop_error:    {de:'Bot-Loop Fehler',en:'Bot loop error',es:'Error del bucle del bot',ru:'Ошибка цикла бота',pt:'Erro no loop do bot'},
  ws_bot_start_degraded:{de:'Bot startet eingeschränkt – Exchange später verbinden',en:'Bot starting degraded – connect exchange later',es:'Bot iniciando en modo degradado: conecta exchange después',ru:'Бот запускается в ограниченном режиме — подключите биржу позже',pt:'Bot iniciando em modo degradado — conecte a exchange depois'},
  ws_bot_start_failed_exchange:{de:'Bot-Start abgebrochen – Exchange nicht erreichbar',en:'Bot start aborted – exchange unreachable',es:'Inicio del bot cancelado: exchange no disponible',ru:'Запуск бота отменён — биржа недоступна',pt:'Inicialização do bot cancelada — exchange indisponível'},
  ...
  ws_rollback_partial:  {de:'Rollback teilweise: lokale Änderungen konnten nicht gestasht werden',en:'Rollback partial: local changes could not be stashed',es:'Rollback parcial: no se pudieron guardar los cambios locales',ru:'Частичный откат: локальные изменения не удалось поместить в stash',pt:'Rollback parcial: não foi possível aplicar stash às alterações locais'},
