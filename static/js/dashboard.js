      ...
      <div class="card-hd" style="padding-bottom:10px">
        <div style="display:flex;align-items:center;gap:8px">
          ...
          <div>
            ...
            <div style="font-size:10px;color:var(--sub);font-family:var(--mono)">
              ${marketCount} Märkte · ${(ex.trade_mode||'paper').toUpperCase()} · ${ex.last_scan||'—'}${statusDetail ? ` · ${esc(statusDetail)}` : ''}
            </div>
          </div>
        </div>
        ...
        <div style="display:flex;gap:8px;margin-top:12px">
          ${!enabled
            ...
            : running
              ...
              : `<button class="btn btn-jade" style="flex:1;padding:8px;font-size:12px" onclick="mexStart('${escJS(id)}','paper')">▶ Paper</button>
                 <button class="btn btn-purple" style="flex:1;padding:8px;font-size:12px" onclick="mexStart('${escJS(id)}','live')">▶ Live</button>
                 <button class="btn btn-info" style="flex:1;padding:8px;font-size:12px" onclick="mexSetupKeys('${escJS(id)}')">🔑 Keys</button>`
          }
        </div>
      </div>
...
function mexStart(name, mode='paper')  { _emitSafe('start_exchange',  {exchange: name, mode}); }
