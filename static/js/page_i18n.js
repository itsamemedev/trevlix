/* ═══════════════════════════════════════════════════════════
   TREVLIX v1.0.0 – Static Page i18n
...
const PT = {
  ...
  faq_a3:  {de:'Aktuell werden 5 Exchanges unterstützt: <strong>Crypto.com</strong>, <strong>Binance</strong>, <strong>Bybit</strong>, <strong>OKX</strong> und <strong>KuCoin</strong>. Die Integration erfolgt über die CCXT-Bibliothek, sodass weitere Exchanges leicht hinzugefügt werden können.',en:'Currently 5 exchanges are supported: <strong>Crypto.com</strong>, <strong>Binance</strong>, <strong>Bybit</strong>, <strong>OKX</strong> and <strong>KuCoin</strong>. Integration is via the CCXT library, so additional exchanges can easily be added.',es:'Actualmente se admiten 5 exchanges: <strong>Crypto.com</strong>, <strong>Binance</strong>, <strong>Bybit</strong>, <strong>OKX</strong> y <strong>KuCoin</strong>. La integración es a través de la biblioteca CCXT, por lo que se pueden agregar más exchanges fácilmente.',ru:'Поддерживается 5 бирж: <strong>Crypto.com</strong>, <strong>Binance</strong>, <strong>Bybit</strong>, <strong>OKX</strong> и <strong>KuCoin</strong>. Интеграция через библиотеку CCXT, дополнительные биржи добавляются легко.',pt:'São suportadas 5 exchanges: <strong>Crypto.com</strong>, <strong>Binance</strong>, <strong>Bybit</strong>, <strong>OKX</strong> e <strong>KuCoin</strong>. A integração é via biblioteca CCXT, então outras exchanges podem ser adicionadas facilmente.'},
