...
# ║     ╚═╝   ╚═╝  ╚═╝╚══════╝  ╚═══╝  ╚══════╝╚═╝╚═╝  ╚═╝                   ║
# ║                                                                              ║
# ║  Algorithmic Trading Intelligence  ·  Installer v1.0.0                      ║
...
EOF
echo -e "${RESET}"
echo -e "  ${DIM}Algorithmic Trading Intelligence · Installer v1.0.0${RESET}"
...
mysql -u root -e "$SQL_CMD" 2>/dev/null || mysql -u root --execute="$SQL_CMD" 2>/dev/null || true
...
# TREVLIX v1.0.0 – Auto-generiert am $(date)
