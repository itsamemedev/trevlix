...
def build_default_config(secret_factory: Callable[[str], Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "quote_currency": "USDT",
        "supported_quote_currencies": ["USDT", "USDC"],
        ...
        "virginie_open_threshold": 0.50,
        "virginie_min_score": 0.5,
        "virginie_max_risk_penalty": 5.0,
        "virginie_fast_path_threshold": 0.80,
        ...
        "telegram_on_buy": _env_bool("TELEGRAM_ON_BUY", "false"),
        "telegram_on_sell": _env_bool("TELEGRAM_ON_SELL", "false"),
        "telegram_on_error": _env_bool("TELEGRAM_ON_ERROR", "false"),
        "telegram_on_algo_signals": _env_bool("TELEGRAM_ON_ALGO_SIGNALS", "false"),
        ...
        "discord_on_algo_signals": _env_bool("DISCORD_ON_ALGO_SIGNALS", "true"),
