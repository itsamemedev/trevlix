...
def build_default_config(secret_factory: Callable[[str], Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "telegram_on_buy": _env_bool("TELEGRAM_ON_BUY", "true"),
        "telegram_on_sell": _env_bool("TELEGRAM_ON_SELL", "true"),
        "telegram_on_error": _env_bool("TELEGRAM_ON_ERROR", "true"),
        "telegram_on_algo_signals": _env_bool("TELEGRAM_ON_ALGO_SIGNALS", "true"),
